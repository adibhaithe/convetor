document.addEventListener('DOMContentLoaded', () => {
    ...
    convertBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            conversionStatus.textContent = 'Converting PDF to PowerPoint...';
            ...
            const extractShapes = document.getElementById('extractShapes').checked;
            ...
            // Set slide size based on layout
            if (slideLayout === 'standard') {
                pptx.layout = 'LAYOUT_4x3';
            } else if (slideLayout === 'widescreen') {
            ...
            conversionResult.innerHTML = `
                <div class="conversion-info">
                    ...
                    <p>Presentation is ready for download</p>
                </div>
            `;
